...
INSERT INTO `campus_category` (`category_id`, `category_name`, `parent_id`, `order_num`, `slug`, `description`, `type`, `icon`, `status`, `del_flag`, `create_time`, `create_user`, `update_time`, `update_user`) VALUES (1465662542308495361, '通讯', 0, 10, 'solid', '实时最新消息', 'N', 'system', '0', b'0', '2021-11-30 20:42:35', NULL, '2022-12-26 17:57:48', 1);
...
INSERT INTO `campus_comment` (`comment_id`, `parent_id`, `one_level_id`, `user_id`, `to_user_id`, `content_id`, `co_content`, `ip`, `address`, `del_flag`, `create_time`, `create_user`, `update_time`, `update_user`) VALUES (1636190372501934082, 0, -1, 1594285543804383234, -1, 1635923549986508801, '1', '127.0.0.1', '内网IP', b'0', '2023-03-16 10:19:18', 1594285543804383234, '2023-03-16 10:19:18', NULL);
COMMIT;
...
INSERT INTO `campus_content` (`content_id`, `user_id`, `category_id`, `content`, `status`, `type`, `file_count`, `love_count`, `is_anonymous`, `remark`, `del_flag`, `create_time`, `create_user`, `update_time`, `update_user`) VALUES (1635923549986508801, 1594285543804383234, 1602336520042287105, '1111111', 1, 0, 0, 0, 0, NULL, b'0', '2023-03-15 16:39:03', 1594285543804383234, '2023-03-15 16:39:21', NULL);
COMMIT;
...
INSERT INTO `sys_user` (`user_id`, `user_name`, `nick_name`, `user_type`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `login_ip`, `login_date`, `remark`, `create_user`, `create_time`, `update_user`, `update_time`, `del_flag`) VALUES (1594285543804383234, 'test', '测试账号', '00', '', '', '0', '', '$2a$10$BrEFSG5siwG4A1wBXgPzxeXlEvHFsh2kOQPu69jjQJjNcH7f2PRx6', '0', '127.0.0.1', '2023-03-20 19:38:34', NULL, 1, '2022-11-20 19:04:29', 1594285543804383234, '2023-03-20 19:38:34', b'0');
COMMIT;
